...
type VertexBuffer struct {
	...
	numVerts int
	numIndices int
	bufferDrawType gl.Enum
}

func NewVertexBuffer(shader *Shader, numVerts, numTris int) *VertexBuffer {
		// TODO: Decide DYNAMIC_DRAW vs STREAM_DRAW vs STATIC_DRAW (I think stream is correct for the render pass buffer, but not correct for static mesh buffers. maybe parameterize to vert buf
	...
	mainthread.Call(func() {
		...
		gl.BufferData(gl.ARRAY_BUFFER, sof * numVerts * b.stride, nil, b.bufferDrawType)

		indexSize := 4 // uint32 // TODO - make this modifiable?
		gl.BindBuffer(gl.ELEMENT_ARRAY_BUFFER, b.ebo)
		gl.BufferData(gl.ELEMENT_ARRAY_BUFFER, indexSize * len(b.indices), nil, b.bufferDrawType)
...
func (v *VertexBuffer) Clear() {
	...
	// Notes about buffer respec: https://www.khronos.org/opengl/wiki/Buffer_Object_Streaming#Buffer_re-specification
	// TODO: Cache func
	mainthread.Call(func() {
		gl.BindBuffer(gl.ARRAY_BUFFER, v.vbo)
		gl.BufferData(gl.ARRAY_BUFFER, sof * v.numVerts * v.stride, nil, v.bufferDrawType)

		indexSize := 4 // uint32 // TODO - make this modifiable?
		gl.BindBuffer(gl.ELEMENT_ARRAY_BUFFER, v.ebo)
		gl.BufferData(gl.ELEMENT_ARRAY_BUFFER, indexSize * v.numIndices, nil, v.bufferDrawType)
	})
